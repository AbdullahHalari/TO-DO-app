...
function addwbook(){
    ...
    data = data.val();
        ...
        <td>${data.date}</td>
        <td><button type="button" class="btn btn-dark" id="button" onclick="delet('${key}');">Delete</button></td>
        <td><button type="button" class="btn btn-dark" id="button" onclick="edit('${key}');"data-toggle="modal" data-target="#myModal">Edit</button></td>
    </tr>`    
    });
}
